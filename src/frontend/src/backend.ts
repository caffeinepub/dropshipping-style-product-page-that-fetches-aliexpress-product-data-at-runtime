...
export class Backend implements backendInterface {
    ...
    async fetchAliExpressProduct(arg0: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.fetchAliExpressProduct(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async placeOrder(arg0: CustomerInfo, arg1: bigint): Promise<string> {
        if (this.processError) {
            try {
    ...
    async removeFromCart(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
